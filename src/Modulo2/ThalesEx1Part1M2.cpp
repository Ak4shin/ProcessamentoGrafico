...
int main()
{
	...
	vector<GLuint> VAOs;
	VAOs.push_back(createTriangle(-0.65f, 0.33f, -0.27f, 0.53f, -0.61f, 0.79f)); // Triângulo original
    VAOs.push_back(createTriangle(-0.2f, 0.1f, 0.1f, 0.3f, -0.15f, 0.55f));      // Triângulo deslocado à direita
    VAOs.push_back(createTriangle(0.3f, -0.2f, 0.6f, 0.0f, 0.35f, 0.25f));       // Triângulo mais abaixo e à direita
    VAOs.push_back(createTriangle(-0.8f, -0.5f, -0.5f, -0.3f, -0.75f, -0.1f));   // Triângulo no canto inferior esquerdo
    VAOs.push_back(createTriangle(0.0f, 0.6f, 0.3f, 0.8f, -0.05f, 1.0f));        // Triângulo no topo central
