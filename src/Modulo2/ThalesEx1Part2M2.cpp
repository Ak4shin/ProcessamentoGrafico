...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Ola Triangulo! -- Thales Roberto", nullptr, nullptr);
	...
	colors.push_back(vec3(57, 255, 20));    // Neon Green
    colors.push_back(vec3(255, 20, 147));   // Deep Pink
    colors.push_back(vec3(0, 255, 255));    // Aqua
    colors.push_back(vec3(255, 255, 0));    // Bright Yellow
    colors.push_back(vec3(255, 0, 255));    // Magenta
    colors.push_back(vec3(0, 255, 127));    // Spring Green
    colors.push_back(vec3(0, 191, 255));    // Deep Sky Blue
    colors.push_back(vec3(255, 69, 0));     // Orange Red
    colors.push_back(vec3(173, 255, 47));   // Green Yellow
    colors.push_back(vec3(75, 0, 130));     // Indigo
